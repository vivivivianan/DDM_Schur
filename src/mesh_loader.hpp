...
// COMSOL mesh import, P2 node completion, boundary extraction, and interface matching.
...
static bool boundaryMatches(const BoundaryFace& face, const HeatFluxCondition& condition)
{
    return condition.boundaryEntity == face.boundaryEntity
        && (condition.subdomain < 0 || condition.subdomain == face.subdomain);
}
