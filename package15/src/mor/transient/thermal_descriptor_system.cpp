...
// sipg_core.hpp forward-declares this translation-unit helper because its
// diagnostics use the same CSV convention. Most application units obtain the
// definition from diagnostics_io.hpp; keep this MOR assembly unit independent
// of that large header.
