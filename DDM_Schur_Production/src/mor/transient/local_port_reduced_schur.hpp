...
// Compatibility schema for removed port-reduction experiments. Keeping these
// POD/Steklov model types preserves the upstream workflow's diagnostic layout;
// no port basis builder or port-reduced solver is available in production.
