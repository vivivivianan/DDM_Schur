// Memory accounting for serialized local-ROM models. Counts include only
// owned payloads: repeated HBM instances reference one representative template
// and therefore must not charge its dense basis/reduced blocks repeatedly.
