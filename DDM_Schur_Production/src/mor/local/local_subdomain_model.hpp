...
// Persistent local-ROM schema. Each subdomain owns global maps and reference
// state metadata; a representative template owns V_i and projected A blocks.
// Field order/version participate in cache compatibility.
