// Convert configured heat sources and boundary loads into affine input
// channels. Stable channel order and metadata fingerprints are required so a
// cached ROM cannot be reused after source semantics change.
