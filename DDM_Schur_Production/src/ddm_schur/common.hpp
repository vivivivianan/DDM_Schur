...
// Shared data contracts for domain/interface partitioning. Options and report
// fields are wider than this production build because the retained workflow
// preserves its historical CSV schema; only augmented-direct fields are live.
